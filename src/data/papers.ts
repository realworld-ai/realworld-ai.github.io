...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    abstractShortEn: "We propose a method to improve the accuracy of packaging work recognition based on acceleration data using Motif-Guided Attention Networks (MGA-Net+).",
  ...
  },
  {
    ...
    abstractShortEn: "We propose a method to predict how much the performance of a human activity recognition model will improve with additional data collection.",
