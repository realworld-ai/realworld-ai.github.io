...
export const researchAreas: ResearchArea[] = [
  {
    ...
    description: "人間行動認識技術は、センサなどのデバイスから観測されたセンサデータを用いて、観測対象の行動を認識するAI技術です。スマートファクトリーやスマートヘルスケア、スマートホームなど我々の未来の生活や産業を実現するための基盤となる技術です。実世界知能基盤講座では、特にスマートファクトリーやライフサイエンス実験などにおける複雑行動を認識・理解し、コーチングや産業ロボットに活用する実世界AIの研究開発をしています。",
